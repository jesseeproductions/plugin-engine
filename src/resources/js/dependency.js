/**
 * PNGX Dependency. Based of Modern Tribe Dependency Allows us to conditionally hide/show and disable elements
...
( function( $, _, obj ) {
	...
	var selectors = {
		...
		active: '.pngx-active',
		dependency: '.pngx-dependency',
		dependencyVerified: '.pngx-dependency-verified',
		fields: 'input, select, textarea',
		advanced_fields: '.select2-container',
		linked: '.pngx-dependent-linked'
	};
