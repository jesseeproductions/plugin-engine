 ...
 *      $data = new Pngx__Data( $my_data, 'nope' );
 *
 ...
 * Class Pngx__Data
 */
class Pngx__Data implements ArrayAccess, Iterator { // phpcs:ignore TEC.Classes.ValidClassName.NotSnakeCase,WordPress.NamingConventions.ValidClassName.InvalidClassName,PEAR.NamingConventions.ValidClassName.Invalid,Generic.Classes.OpeningBraceSameLine.ContentAfterBrace
	/**
	 * @var int
	 */
	protected $index = 0;
