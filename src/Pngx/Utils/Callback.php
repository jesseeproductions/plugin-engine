...
class Pngx__Utils__Callback {
	...
	/**
	 * When used to wrap a Pngx callback this will be the slug or class to build.
	 *
	 * @var string
	 */
	protected $slug;
	...
	/**
	 * When used to wrap a Pngx callback this will be the method to call.
	 *
	 * @var string
	 */
	protected $method;
	...
	/**
	 * Returns the Value passed as a simple Routing method for pngx_callback_return
	 *
	 * @since  4.6.2
	 *
	...
	public function __call( $method, $args ) {
		...
		// Allow for previous compatibility with pngx_callback
		if ( ! $item->is_empty ) {
			$args = $item->arguments;
		}
	...
	/**
	 * Pngx__Utils__Callback constructor.
	 *
	 * This is used to wrap a Pngx callable couple, a bound slug and method, to be used as a serializable callback.
	 *
	 * @since 4.9.5
	 *
	 ...
	 *
	 * This only makes sense if this class is being used to wrap a Pngx callback couple (slug and method).
	 *
	 * @since 4.9.5
	 *
	 * @return string|null This Pngx callback wrapper slug or class.
	 */
	 ...
	 * @since 4.9.5
	 *
	 * @return string|null This Pngx callback method.
	 */
