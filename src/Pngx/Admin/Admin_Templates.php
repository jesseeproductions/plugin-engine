...
/**
 * Class Pngx__Admin__Admin_Templates
 *
 */
class Pngx__Admin__Admin_Templates {
	...
	public function load_templates() {
		...
		if ( ! isset( $_POST['action'] ) || 'cctor_templates' != $_POST['action'] ) {
			wp_send_json_error( __( 'Permission Error', 'coupon-creator-add-ons' ) );
		}
		...
		//	wp_send_json_error( __( 'No Extension ID', 'coupon-creator-add-ons' ) );
		//}

		if ( ! isset( $_POST['template'] ) ) {
			wp_send_json_error( __( 'No Template ID', 'coupon-creator-add-ons' ) );
		}
