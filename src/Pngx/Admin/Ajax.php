...
class Pngx__Admin__Ajax {
	...
	protected function start() {
		...
		//add_action( 'wp_ajax_nopriv_pngx_templates', [ $this, 'load_templates' ] );
	...
	public function load_variety() {
		...
		if ( ! isset( $_POST['field'] ) ) {
			wp_send_json_error( __( 'No Field ID', 'plugin-engine' ) );
		}

		if ( ! isset( $_POST['option'] ) ) {
			wp_send_json_error( __( 'No Option ID', 'plugin-engine' ) );
		}
