...
$wrap_classes = [ 'pngx-volt-vectors-options-control', 'pngx-volt-vectors-options-control__text-wrap' ];
if ( ! empty( $classes_wrap ) ) {
	$wrap_classes = array_merge( $wrap_classes, $classes_wrap );
}

$label_classes = [ 'pngx-volt-vectors-options-control__label' ];
if ( ! empty( $classes_label ) ) {
	$label_classes = array_merge( $label_classes, $classes_label );
}

$input_classes = [ 'pngx-volt-vectors-options-control__text-input' ];
